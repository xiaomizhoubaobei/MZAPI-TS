...
/**
 * ERNIE_35_128K_Preview类用于与百度文心大模型ERNIE-4.0-Turbo-8K-Preview进行交互
 *
 ...
 * ```typescript
 * // 创建实例
 * const ernie = new ERNIE_35_128K_Preview('your_api_key', 'your_secret_key');
 *
 * // 基本对话示例
 ...
 * ```
 */
export class Ernie_35_128K_Preview extends BaiduERNIEBase {
    /**
     * 创建ERNIE_35_128K_Preview实例
     *
     ...
     * // 错误处理示例
     * try {
     *   const ernie = new ERNIE_35_128K_Preview('', ''); // 将抛出错误
     * } catch (error) {
