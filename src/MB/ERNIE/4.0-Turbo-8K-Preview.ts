...
/**
 * Ernie4_8K_Turbo_8k_Preview类用于与百度文心大模型ERNIE-4.0-Turbo-8K-Preview进行交互
 *
 ...
 * ```typescript
 * // 创建实例
 * const ernie = new Ernie4_8K_Turbo_8k_Preview('your_api_key', 'your_secret_key');
 *
 * // 基本对话示例
 ...
 * ```
 */
export class Ernie4_8K_Turbo_8k_Preview extends BaiduERNIEBase {
    /**
     * 创建Ernie4_8K_Turbo_8k_Preview实例
     *
     ...
     * // 错误处理示例
     * try {
     *   const ernie = new Ernie4_8K_Turbo_8k_Preview('', ''); // 将抛出错误
     * } catch (error) {
    ...
    constructor(apiKey: string, secretKey: string) {
        const apiUrl = BaiduERNIEBase.BASE_URL + 'ernie-4.0-turbo-8k-preview';
